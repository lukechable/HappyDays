...
export function CalendarPage() {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col lg:h-[calc(100svh_-_48px)] lg:flex-none">
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-border px-3 py-2 flex-wrap">
        ...
        <h1 className="min-w-0 truncate font-display text-base sm:text-lg">{mode === "day" ? rangeStart.toLocaleDateString("en-AU", { weekday: "long", day: "numeric", month: "long" }) : `${rangeStart.toLocaleDateString("en-AU", { day: "numeric", month: "short" })} – ${new Date(rangeEnd.getTime() - 1).toLocaleDateString("en-AU", { day: "numeric", month: "short", year: "numeric" })}`}</h1>
